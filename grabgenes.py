...
parser = argparse.ArgumentParser(
    description="given a list of predicted genes pull out correspondimng fasta records")
parser.add_argument('names',
                    help='path to text file with desired fasta record ids as lines')
parser.add_argument('fasta',
                    help='path to fasta file containing sequences to be extracted from')
parser.add_argument('-o', default="grabgenesout",
                    help='path to desired output directory')
parser.add_argument('--prefix', default="extracted_records",
                    help="output file prefix")
parser.add_argument('-s', action="count", default=0,
                    help="include to write each gene as a single fasta file")
parser.add_argument('-r', default='',
                    help="string to be used to rename gene records pulled")
